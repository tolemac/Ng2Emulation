...
function minErr(module:any, ErrorConstructor?:any) : any{
...
function isArrayLike(obj) {
	...
	if (angular.isArray(obj) || angular.isString(obj) ) return true;
...
function decorateNgRepeat(app: ng.IModule) {
	app.config(["$provide", ($provide: ng.auto.IProvideService) => {
		$provide.decorator("ngRepeatDirective", ["$delegate", "$injector", ($delegate, $injector) => {
...
export default decorateNgRepeat;